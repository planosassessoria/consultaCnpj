...
const firstRequest = () => request({
  encoding: null,
  url: 'http://www.receita.fazenda.gov.br/pessoajuridica/cnpj/cnpjreva/Cnpjreva_solicitacao3.asp',
  method: 'GET',
  resolveWithFullResponse: true
})

const requestData = (session, proxy = '') => {
  return request({
    encoding: null,
...
const getData = (session, proxy) =>
  requestData(session, proxy)
